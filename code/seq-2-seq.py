...
with open("./pickle_files/padded_input_BNC.pkl",'rb') as f:
    padded_input = pickle.load(f)

with open("./pickle_files/padded_output_BNC.pkl",'rb') as f:
    padded_output = pickle.load(f)

with open("./pickle_files/word_to_index_BNC.pkl",'rb') as f:
    word_to_index = pickle.load(f)

with open("./pickle_files/decoder_input_data_BNC.pkl",'rb') as f:
    decoder_input_data = pickle.load(f)

with open("./pickle_files/decoder_target_data_BNC.pkl",'rb') as f:
